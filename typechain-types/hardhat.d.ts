...
declare module "hardhat/types/runtime" {
  interface HardhatEthersHelpers extends HardhatEthersHelpersBase {
    ...
    getContractFactory(
      name: "MockedTokenExchange",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.MockedTokenExchange__factory>;
    getContractFactory(
      name: "TokenCount",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ): Promise<Contracts.TokenCount__factory>;
    getContractFactory(
      name: "TokenExchange",
      signerOrOptions?: ethers.Signer | FactoryOptions
    ...
    getContractAt(
      ...
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.MockedTokenExchange>;
    getContractAt(
      name: "TokenCount",
      address: string,
      signer?: ethers.Signer
    ): Promise<Contracts.TokenCount>;
    getContractAt(
      name: "TokenExchange",
      address: string,
      signer?: ethers.Signer
